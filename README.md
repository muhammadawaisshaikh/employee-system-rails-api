...
> So you need the next parameters to access: access-token, client, uid, expiry

http://localhost:3000/v1/auth/sign_in (POST)
http://localhost:3000/v1/auth/sign_out (DELETE)
